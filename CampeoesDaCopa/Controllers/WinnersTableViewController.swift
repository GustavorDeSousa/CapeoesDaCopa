...
class WinnersTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let vc = segue.destination as!  WolrdCupViewController
    ...
    //Quando se utiliza Apenas uma seção, o metodo nã precisa ser implementado!!!
    /*
    ...
    //Metodo chamado sempre que for apresentar uma celula.
